require 'connection/talking_token_spec'
require 'connection/request_spec'
require 'connection/response_spec'
...
shared_context "connection:" do
  ...
  describe "The service-connection gem is the messenger among ideas4all services. It:
    ...
    context "Service::Connection: this class access target endpoints carrying params." do
      ...
      before do
        allow(valid_talking_token_data).to receive(:headers).and_return({})
      end
